...
Agar user 3 dalega to 6 print karega, 7 dalega toh 5040 print karega aur aise hi dusre numbers ke lie.Note:
 Abhi ke liye yeh soch lo ki user sirf positive integers hi dalega. Negative integers kabhi nahi dalega.'''
